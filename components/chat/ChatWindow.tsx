...
export function ChatWindow() {
  return (
    <div className="glass-card flex h-full flex-col">
      <header className="flex items-start justify-between gap-3 border-b border-[#e7dfd4] px-6 pb-5 pt-6">
        <div>
      ...
      <div className="flex-1 space-y-6 overflow-y-auto px-6 py-6 text-[#3f3a33]">
        {MESSAGES.map((message) => (
          <MessageBubble key={message.id} {...message} />
        ))}
      </div>

      <div className="border-t border-[#e7dfd4] px-6 py-5">
